const reportSteel = () => {
    ...
    let userSteelFlowUltimate = document.querySelector('#steel-flow-ultimate')
        ...
        content: [
...

            {
                ul: [
                    ...
                    `Esfuerzo último de fluencia, fu=${userSteelFlowUltimate.value} kg/cm².`,
